/**
 * UR1.5 doodle beer mug — extracted verbatim from Hero so it can be reused
 * (e.g. shrunk into the UR1.1 map card corner) without duplicating the art.
 *
 * Procedural mini doodle (mug + foam + cheers bubble); follows theme tokens
 * via CSS vars — no hardcoded colors.
 */

type BeerMugDoodleProps = {
  cheersLabel: string;
  className?: string;
};

export function BeerMugDoodle({ cheersLabel, className }: BeerMugDoodleProps) {
  return (
    <svg
      viewBox="0 0 300 260"
      width="100%"
